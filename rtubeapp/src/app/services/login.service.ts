...
export class LoginService {
    ...
    logout() {
        ...
        // localStorage.removeItem('currentUserImg');
        // localStorage.setItem('currentReload', '1');

        this.router.navigate(['./']);
    }

   
    viewOrderlistdataTable() {
        setTimeout(function () {
    ...
    viewsActivate() {
        ...
        jQuery(document).ready(function(jQuery){
            "use strict";
            //alert("testing viewsActivate service");
